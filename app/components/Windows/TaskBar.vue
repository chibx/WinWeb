    ...
    >
        <div class="w-full">
            <div id="task-wrapper" class="h-full pl-2.5 flex items-center gap-0.5 absolute top-1/2 -translate-y-1/2">
                <WindowsTaskBarIcon class="windows-start-icon" name="Start" icon="/icons/windows_11.svg" :r-click />

                <WindowsTaskBarIcon name="Microsoft Copilot" icon="/icons/microsoft-copilot.svg" :r-click />
