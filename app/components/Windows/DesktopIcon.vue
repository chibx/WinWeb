...
<template>
  <div ref="app-icon" @click="hasFocus = true" class="desktop-icon w-[75px] h-fit px-2.5 py-1.5"
    :class="{ clicked: hasFocus }" :title="name" :aria-label="name" @contextmenu.prevent="rClick">
