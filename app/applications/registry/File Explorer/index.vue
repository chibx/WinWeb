...
import FileExplorerMenuBar from '~/applications/registry/File Explorer/components/MenuBar.vue';
import FileExplorerTopMenu from '~/applications/registry/File Explorer/components/TopMenu.vue';
...
const tabs = shallowReactive<FileExplorerTabProp[]>([
    initialEntry
])
...
const $path = computed({
    ...
    set: (val) => {
        ...
        if (currentTab) { currentTab.path = val }
    }
})
